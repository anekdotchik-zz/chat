    ...
    <div class="chat-body">
        ...
        <div class="chat-send">
            ...
            <input class="message" id="message" type="text"
                onkeyup="if (event.keyCode == 13) {var msg = document.getElementById('message').value; if(msg){chat.send(msg)};}"></input>
            <div class="button-panels">
                <ul>
                    <li><div class="button" id="send">
                            <a href="#"
                                onclick="var msg = document.getElementById('message').value; if(msg){chat.send(msg)};">Send</a>
                        </div></li>
